...
1. Atualize primeiro `doc/04-arquitetura.md` e/ou `doc/05-regras-de-negocio.md` (normativos).
2. Registre o resultado datado em `doc/03-pesquisa-e-validacoes.md` ou `doc/06-marcos.md`.
